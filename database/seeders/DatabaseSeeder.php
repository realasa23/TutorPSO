...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('tutor')->insert([
            ['idtutor' => 1, 'nama' => 'Sasha', 'pekerjaan' => 'PWEB Developer', 'deskripsi' => 'Berpengalaman dalam pengembangan web Laravel.', 'fototutor' => 'https://ui-avatars.com/api/?name=Sasha&background=random'],
            ['idtutor' => 2, 'nama' => 'Haryadi', 'pekerjaan' => 'UX Design', 'deskripsi' => 'Ahli membuat prototipe desain aplikasi.', 'fototutor' => 'https://ui-avatars.com/api/?name=Haryadi&background=random'],
            ['idtutor' => 3, 'nama' => 'Khalila', 'pekerjaan' => 'Data Analyst', 'deskripsi' => 'Berpengalaman dengan graph database.', 'fototutor' => 'https://ui-avatars.com/api/?name=Khalila&background=random'],
        ]);
