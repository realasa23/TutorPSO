...
@section('content')
    ...
    <div class="content-container">
        ...
        <div class="mt-4">
            <p class="title-sesi">Sesi yang Sudah Berlalu</p>
        ...
        <div class="d-flex justify-content-between align-items-end play-box mb-3">
            ...
            <button class="btn btn-lg p-0" aria-label="Play Rekaman">
    ...
    <div class="p-3 bg-white">
        <button id="reviewBtn" class="btn w-100 full-width-btn fw-bold">
            <h5>Ulas Sesi</h5>
        </button>
    </div>
    ...
    <script>
        ...
        downloadBtn.addEventListener('click', () => {
            // Tampilkan notifikasi overlay (tanpa proses download)
